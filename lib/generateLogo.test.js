...
describe('generateLogo', () => {
    describe('newShape', () => {
        it('should set svg string based on what shape user chooses', () =>{
            ...
            expect(svg).toEqual(`<circle cx="200" cy="200" r="100" fill="blue">`)
        })
    });
    describe('makeLogo', () => {
        it('should return a complete svg file of all components', () => {
            ...
            expect(makeLogo).toEqual(`<svg version="1.1" width="300" height="200" xmlns="https://www.w3.org/2000/svg"> <polygon points="100, 10 40, 198, 78" fill="black"> <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="orange" font-size="48"> tri </text> </svg>`)
        })
    })
})
